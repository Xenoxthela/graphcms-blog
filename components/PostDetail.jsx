...
const PostDetail = ({ post }) => {
  ...
  return (
    <>
      <div className="bg-gray-700 shadow-lg lg:p-3 pb-12 mb-8">
        <div className="relative overflow-hidden shadow-md mb-6">
          <img src={post.featuredImage.url} alt="" className="object-top h-full w-full object-cover  shadow-lg rounded-t-lg lg" />
        </div>
